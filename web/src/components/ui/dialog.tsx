        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                className="absolute top-2 right-2 max-md:top-[max(0.5rem,env(safe-area-inset-top,0px))] max-md:right-[max(0.5rem,env(safe-area-inset-right,0px))] max-md:size-10"
                size="icon-sm"
              />
            }
          >
